...
from pivot_algo import pivot_bsh
from bsh import bsh
...
class pivot_trader():
    ...
    def bsh_decision(self):
        if self.trend != "none":
            # put together necessary data and send to algorithm
            algo_data = {
                "ticker" : self.ticker,
    ...
    def update_trader_data(self, message):
        ...
        if "data" in message.keys():
            ...
            if "1" in content.keys() and "2" in content.keys() and "3" in content.keys():     
                ...
                print("All values exist. Data update executed successfully.")
            
            print("Not all values exist. Data update not executed.")
